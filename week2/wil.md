...
const SecondaryButton = ({
  ...
  function makeHandleClickSubmissionComplete(
    ...
    return async () => {
      ...
      if (response.success) {
        ...
        console.log(
          success,
          currentAssignmentSubmissionStatus,
          "submit handler"
        );
  ...
  const handleClickSubmissionComplete = async (
    ...
    if (response.success) {
      ...
      console.log(success, assignmentSubmissionStatus, "submit handler");
      if (currentAssignmentSubmissionStatus === "SUCCESS") {
        toast.success("과제 제출이 완료되었습니다.");
      } else if (currentAssignmentSubmissionStatus === "FAILURE") {
        toast.error("과제 제출에 실패했습니다.");
  ...
  return (
    <Button
      ...
      onClick={makeHandleClickSubmissionComplete(assignmentSubmissionStatus)}
    >
      {secondaryButtonText}
    </Button>
  );
